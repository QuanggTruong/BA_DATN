...
class VNPay {
    constructor(_a) {
        ...
        this.globalDefaultConfig = Object.assign({ vnpayHost,
            vnp_Version,
            vnp_CurrCode,
            vnp_Locale, vnp_OrderType: enums_1.ProductCode.Other, vnp_Command: constants_1.VNP_DEFAULT_COMMAND }, config);
    }
    /**
    ...
    buildPaymentUrl(data, options) {
        ...
        const redirectUrl = (0, payment_util_1.createPaymentUrl)(this.globalDefaultConfig, dataToBuild);
        const signed = (0, payment_util_1.calculateSecureHash)(this.globalDefaultConfig.secureSecret, redirectUrl.search.slice(1).toString(), this.HASH_ALGORITHM, this.BUFFER_ENCODE);
    ...
    verifyReturnUrl(query, options) {
        ...
        const isVerified = (0, payment_util_1.verifySecureHash)(this.globalDefaultConfig.secureSecret, searchParams.toString(), this.HASH_ALGORITHM, vnp_SecureHash);
        let outputResults = {
            isVerified,
